...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="#" style="background-color:#0eb7da; color:#000000;">Quizzes</a></li>
            </ul>
...
<!--home start-->
<?php if(@$_GET['q']==1) {
echo "<script>alert('Warning:Changing the tab during the quiz will result in ending it.');</script>";
...
//echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	//<td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-btn" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Ended</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div>';
  ...
  if( hidden !== null){
      document.addEventListener(vChange, function(ev){
          ...
          if(document[hidden]){
              ...
              window.location='http://localhost:8080/Student/homepage.php'; //return to homepage
              //page has lost focus
