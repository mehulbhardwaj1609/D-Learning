...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://localhost:8080/ML/masterlogin.html" onclick="signOut();"><span
                            class="glyphicon glyphicon-log-in"></span> Sign Out</a></li>
                <script>
                    function signOut() {
                      
                        gapi.auth.authorize({ 'client_id': '' , 'scope': SCOPES, 'immediate': false, cookie_policy: 'single_host_origin', response_type: 'token id_token' }, function (authResult) {
                            gapi.auth.signOut();
                            setTimeout(function () {
                                gapi.auth.authorize({ 'client_id': '', 'scope': SCOPES, 'immediate': true, cookie_policy: 'single_host_origin' }, function (authResult) {
