...
define('DB_SERVER_USERNAME', 'googlemananrajco_db');
define('DB_SERVER_PASSWORD', 'googlemananrajco_db');
define('DB_DATABASE', 'googlemananrajco_db');
...
define("SITE_URL", "https://google.mananraj.co.in/login_system_with_google/");
...
define("CLIENT_ID", "561095451699-hgjilog87lh6u7epuukk5941pvpisn39.apps.googleusercontent.com"); 
define("CLIENT_SECRET", "zijK3V-FCkrr48bT0PZRonWN");
